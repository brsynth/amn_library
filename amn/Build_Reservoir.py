...
def RC_prior(Prior_inputs, parameter, verbose=False):
    ...
    from amn.Build_Model import Dense_layers
...
def RC(parameter, verbose=False):
    ...
    from amn.Build_Model import my_mae, my_mse, CROP
    from amn.Build_Model import my_r2, my_acc, my_binary_crossentropy
...
class RC_Model:
    ...
    def __init__(self, 
        ...
        from amn.Build_Model import Neural_Model
        from sklearn.preprocessing import MinMaxScaler
...
def RC_run(reservoirfile, X, Y, 
    ...
    from amn.Build_Model import train_evaluate_model, evaluate_model, model_input
...
def RC_write_multiple(reservoirfile, resultfile, 
    ...
    from amn.Utilities import write_csv
    from amn.Build_Model import Neural_Model
    from amn.Build_Model import train_evaluate_model, evaluate_model, model_input
    from amn.Build_Dataset import get_minmed_varmed_ko
    from sklearn.metrics import r2_score
